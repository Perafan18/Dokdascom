...
<style>
        	...
        	#div{
			    background-image: url(http://www.dokdas.com/img/p2.jpg);
			    width: 100%;
			    z-index:-10;
			    margin-top:480px;
			    height: 600px;
			...
			#div2{
			    background-image: url(http://www.dokdas.com/img/p3.jpg);
			    width: 100%;
			    z-index:-20;
			    margin-top:800px;
			    height: 1200px;
    					...
    					<div class="row-fluid">
    						<div class="span10 offset1">
    							<h4 class="text-error">Error :
									...
									switch ($numero) {
										case 1:
										echo "No se capturaron todos los campos";
											break;
										case 2:
										echo "Los correos electronicos no son iguales";
											break;
										case 3:
										echo "Ya hay un usuario usando ese correo electronico";
											break;
										default:
		    					...
		    					<form class="form-horizontal" action="http://www.dokdas.com/welcome/registrarse" method="post">
								    ...
								    <div class="control-group">
									    ...
									    <div class="controls">
									    	<input type="text" name="Recorreo" id="Recorreo" placeholder="Repite el correo electronico">
									    </div>
								    </div>
								    <div class="control-group">
